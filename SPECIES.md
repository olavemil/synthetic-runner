...
- Speaker sends message on behalf of colony
...
- Each personality suggests an avenue of response, as well as an argument for who it is a good reply
- Each votes for one of the other two
  - If one response gets two votes, it wins out
  - If all responses get one vote, they are joined
- In random order
  - Each personality rewords the selected response with its own thinking in context
- The reprocessed response is then sent as reply
